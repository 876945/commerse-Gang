...
ROOT_URLCONF = 'commerse_gang.urls'
...
WSGI_APPLICATION = 'commerse_gang.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'posts' / 'static',  # Your local static files
]
...
# Login URL for @login_required decorators (if you use them)
LOGIN_URL = '/guest-login/'  

# Optional: Messages framework styling (Bootstrap like)
